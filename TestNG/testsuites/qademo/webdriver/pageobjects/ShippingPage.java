...
public class ShippingPage extends CommonSectionPage {
	...
	private final Logger logger= Logger.getLogger(this.getClass().getPackage().getName());
	   ...
	   public ShippingPage() {
	    	...
	    	WebDriverUtil.myWaitForVisible(driver, shippingTitleBy, WebElementWait.DEFAULT_SLEEP_TIMEOUT);
       ...
       public double getTotalSum() {
    	   ...
    	   WebDriverUtil.myWaitForPresence(driver, priceBy, 60);
       ...
       protected  void shippingAddressIsSame() {
    	   ...
    	   WebDriverUtil.myWaitForClickable(driver, shippingBillSameBy, WebElementWait.DEFAULT_SLEEP_TIMEOUT);
    	       	   
    	   if (!checkbox.isSelected()) {
    		   CommonControlUtil.multiStepMoveClick(driver, checkbox, WebElementWait.DEFAULT_SLEEP_TIMEOUT);
    	   }
    	   } catch (Exception e) {
    		   e.printStackTrace();
	   ...
	   public CheckoutPage goBackToCheckout() {
		   WebDriverUtil.myWaitForClickable(driver, goBackBy, WebElementWait.DEFAULT_SLEEP_TIMEOUT);
	   ...
	   public  TransactionResultPage makePurchase() { 
		   ...
		   CommonControlUtil.multiStepMoveClick(driver, driver.findElement(purchaseBy), WebElementWait.DEFAULT_SLEEP_TIMEOUT);
	   ...
	   public TransactionResultPage completeOrder(String email, String firstName, String lastName, String address, String city, String state, String country, String phone, boolean isShipAddressSame) {
		   ...
		   WebDriverUtil.myWaitForVisible(driver, purchaseBy, WebElementWait.DEFAULT_SLEEP_TIMEOUT);
		   WebDriverUtil.myWaitForVisible(driver, billingEmailBy, WebElementWait.DEFAULT_SLEEP_TIMEOUT);
